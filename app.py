...
try:
    ...
    # 2. Balances Intercambiador y Ensuciamiento
    ...
    # Efecto real por tiempo (Fouling)
    ...
    h_PS_714_OUT = h_liq(T_PS_714_OUT, P_I_water)
    Q_PS_cedido = m_PS_714 * (h_I_w_out - h_PS_714_OUT)
    
    # Masa de botellas por segundo
    ...
    with c_right:
        ...
        if U_real_kW < (U_ideal_kW * 0.85):
            st.warning("⚠️ Se recomienda programar limpieza del intercambiador.")
